...
<body data-spy="scroll" data-target=".bs-docs-sidebar">
	...
	<div class="content">
		...
		<div class="container-fluid">
			...
			<form name="addForm" action="<%=path%>/assets/asset_add.action"
				method="post">
				<table width="400" style="margin:auto">
					<tr>
						<td width="50%">资产ID：</td>
						<td><input type="text" name="aid" size="22" /></td>
					</tr>
					<tr>
						<td width="50%">资产名称：</td>
						<td><input type="text" name="aname" size="22" /></td>
					</tr>
					<tr>
						<td>资产数量：</td>
						<td><input type="text" name="anum" size="22" /></td>
					</tr>
					<tr>
						<td>保管人：</td>
						<td><input type="text" name="akeeper" size="22" /></td>
					</tr>
					<tr>
						<td>单位：</td>
						<td><input type="text" name="aunit" size="22" /></td>
					</tr>
					<tr>
						<td>资产类别：</td>
						<td><input type="text" name="atype" size="22" /></td>
					</tr>
					<tr>
						<td>使用部门：</td>
						<td><input type="text" name="adepart" size="22" /></td>
					</tr>
					<tr>
						<td>资产描述：</td>
						<td><input type="text" name="adescripe" size="22" /></td>
					</tr>
					<tr>
